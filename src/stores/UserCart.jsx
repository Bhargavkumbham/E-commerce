...
const UserCart = () => {
  const { cartItems, savedItems, removeFromCart, saveForLater, moveToCart } = useCart();
            ...
            {savedItems.map((item) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-4 sm:mt-0 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-md px-4 py-2 transition"
                >
                  Move to Cart
                </button>
              </div>
